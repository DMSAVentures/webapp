...
export const Primary: Story = {
    args: {
        items: [
            <BreadcrumbItem key={'breadcrumb-1'} state={'active'} >Home</BreadcrumbItem>,
            <BreadcrumbItem key={'breadcrumb-2'} state={'default'} >Library</BreadcrumbItem>,
            <BreadcrumbItem key={'breadcrumb-3'} state={'default'} >Data</BreadcrumbItem>,
        ],
        divider: 'arrow',
    },
};
