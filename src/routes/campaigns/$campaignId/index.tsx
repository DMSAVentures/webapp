			...
			<div className={styles.pageContent}>
				...
				{campaign.referral_config && (
					<div className={styles.detailsCard}>
						<h3 className={styles.detailsTitle}>Referral Configuration</h3>
				...
				{campaign.email_config && (
					<div className={styles.detailsCard}>
						<h3 className={styles.detailsTitle}>Email Configuration</h3>
						<div className={styles.detailsList}>
							<div className={styles.detailItem}>
				...
				{campaign.branding_config && (
					<div className={styles.detailsCard}>
						<h3 className={styles.detailsTitle}>Branding Configuration</h3>
						<div className={styles.detailsList}>
				...
				<div className={styles.detailsCard}>
					<h3 className={styles.detailsTitle}>Campaign Metadata</h3>
					<div className={styles.detailsList}>
						<div className={styles.detailItem}>
