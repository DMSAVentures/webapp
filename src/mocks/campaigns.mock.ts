...
export const mockCampaigns: Campaign[] = [
  {
    ...
    description: 'Waitlist for our revolutionary project management tool launching Q2 2025',
    status: 'active',
    formConfig: {
      id: 'form-1',
      ...
      behavior: {
        ...
        successMessage: 'Thank you for joining! Share your link to move up the waitlist.',
        doubleOptIn: true,
        duplicateHandling: 'block',
      },
    },
