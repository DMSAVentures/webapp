...
export const mockRewards: Reward[] = [
  ...
  },
  {
    ...
    description: 'Join our exclusive founder\'s circle with direct access to the team',
...
export const mockRewardsEarned: RewardEarned[] = [
  ...
  },
  {
    ...
    expiresAt: undefined,
    deliveryDetails: {
      instructions: 'Unlimited AI credits have been added to your account for 6 months',
    },
  },
  {
    id: 'earned-11',
...
export const getMockRewardsByStatus = (
...
export const mockUserRewardProgress = (userId: string, referralCount: number) => {
