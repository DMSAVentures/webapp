...
import ButtonGroup, {ButtonItemProps} from "@/components/baseui/buttongroup/buttongroup";
...
const button1: ButtonItemProps = { text: 'Button 1', iconPosition: 'left', icon: 'ri-home-line', iconOnly: false, onClick: () => {},  disabled: false }
const button2: ButtonItemProps = { text: 'Button 2', iconPosition: 'right', icon: 'ri-book-line', iconOnly: false,onClick: () => {}, disabled: false };
