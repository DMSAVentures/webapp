 ...
 */
export const GrowthChart = memo<GrowthChartProps>(function GrowthChart({
	data,
	height = 300,
	...
	// Chart colors using CSS custom properties from design system
	const COLORS = {
		signups: "var(--color-info-default)", // Blue
		referrals: "var(--color-success-default)", // Green
	};
