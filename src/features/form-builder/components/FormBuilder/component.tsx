...
import { memo, useState, useEffect, useCallback, type HTMLAttributes } from 'react';
...
import type { FormConfig, FormField, FormDesign } from '@/types/common.types';
import styles from './component.module.scss';

export interface FormBuilderProps extends Omit<HTMLAttributes<HTMLDivElement>, 'onSave'> {
...
export const FormBuilder = memo<FormBuilderProps>(
  function FormBuilder({
    ...
    useEffect(() => {
      if (hasUnsavedChanges) {
        const timer = setTimeout(() => {
          localStorage.setItem(`form-builder-${campaignId}`, JSON.stringify(config));
    ...
    const handleFieldSelect = useCallback((fieldType: FormField['type']) => {
