...
import { memo, type HTMLAttributes, type ChangeEvent } from 'react';
...
export interface FormStyleEditorProps extends HTMLAttributes<HTMLDivElement> {
...
export const FormStyleEditor = memo<FormStyleEditorProps>(
  function FormStyleEditor({
    ...
    const handleColorChange = (colorKey: keyof FormDesign['colors'], value: string) => {
      onChange({
        ...design,
        colors: {
          ...design.colors,
    ...
    const handleTypographyChange = (key: keyof FormDesign['typography'], value: string | number) => {
      onChange({
        ...design,
        typography: {
          ...design.typography,
    ...
    const handleSpacingChange = (key: keyof FormDesign['spacing'], value: number) => {
      onChange({
        ...design,
        spacing: {
          ...design.spacing,
      ...
      <div className={classNames} {...props}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            {selectedFieldId ? 'Field selected - Edit properties' : 'Customize form appearance'}
          </p>
        </div>
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.layoutOptions}>
              {(['single-column', 'two-column', 'multi-step'] as const).map((layoutType) => (
                <button
                  key={layoutType}
                  type="button"
                ...
                >
                  <i
                    className={
                      layoutType === 'single-column' ? 'ri-layout-line' :
                      layoutType === 'two-column' ? 'ri-layout-column-line' :
                      'ri-layout-row-line'
                    }
                    aria-hidden="true"
                  />
          ...
          <section className={styles.section}>
            ...
            <div className={styles.colorGrid}>
              <div className={styles.colorItem}>
                <label htmlFor="color-primary" className={styles.colorLabel}>
                  Primary
                </label>
              ...
              <div className={styles.colorItem}>
                <label htmlFor="color-background" className={styles.colorLabel}>
                  Background
                </label>
                <div className={styles.colorInputGroup}>
                  <input
              ...
              <div className={styles.colorItem}>
                <label htmlFor="color-text" className={styles.colorLabel}>
                  Text
                </label>
                <div className={styles.colorInputGroup}>
                  <input
              ...
              <div className={styles.colorItem}>
                <label htmlFor="color-border" className={styles.colorLabel}>
                  Border
                </label>
                <div className={styles.colorInputGroup}>
                  <input
              ...
              <div className={styles.colorItem}>
                <label htmlFor="color-error" className={styles.colorLabel}>
                  Error
                </label>
                <div className={styles.colorInputGroup}>
                  <input
              ...
              <div className={styles.colorItem}>
                <label htmlFor="color-success" className={styles.colorLabel}>
                  Success
                </label>
                <div className={styles.colorInputGroup}>
                  <input
          ...
          <section className={styles.section}>
            ...
            <div className={styles.inputGrid}>
              ...
              <TextInput
                ...
                onChange={(e) => handleTypographyChange('fontSize', parseInt(e.target.value) || 16)}
                min={12}
                max={24}
              />
              <TextInput
                ...
                onChange={(e) => handleTypographyChange('fontWeight', parseInt(e.target.value) || 400)}
                min={100}
                max={900}
                step={100}
              />
          ...
          <section className={styles.section}>
            ...
            <div className={styles.inputGrid}>
              <TextInput
                ...
                onChange={(e) => handleSpacingChange('padding', parseInt(e.target.value) || 16)}
                min={0}
                max={100}
              />
              <TextInput
                ...
                onChange={(e) => handleSpacingChange('gap', parseInt(e.target.value) || 16)}
                min={0}
                max={100}
              />
              <TextInput
                ...
                onChange={(e) => handleBorderRadiusChange(parseInt(e.target.value) || 8)}
                min={0}
                max={50}
              />
            </div>
