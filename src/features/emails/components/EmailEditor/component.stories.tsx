...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'WYSIWYG email editor with rich text editing, variable insertion, and preview functionality. Supports desktop and mobile preview modes.',
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  args: {
    initialContent: '<h1>Welcome Email</h1><p>Hi, this is your welcome email template.</p>',
    variables: ['first_name', 'last_name', 'email', 'campaign_name', 'position', 'referral_link'],
    onChange: (html) => {
...
export const MilestoneEmailTemplate: Story = {
  args: {
    initialContent: `
      ...
      <p><a href="{{referral_link}}">Share Your Link</a></p>
    `,
    variables: ['first_name', 'position', 'percentile', 'referral_count', 'referral_link'],
    onChange: (html) => {
      console.log('Content changed:', html);
    },
  },
...
export const Interactive: Story = {
  render: () => {
    const [content, setContent] = useState('<h1>Start editing...</h1><p>Your email content goes here.</p>');

    return (
      <div>
        <EmailEditor
          initialContent={content}
          variables={['first_name', 'last_name', 'email', 'campaign_name', 'position', 'referral_link', 'verification_link']}
          onChange={setContent}
        />
...
export const WithManyVariables: Story = {
  args: {
    initialContent: '<h1>Email Template</h1><p>Click "Insert Variable" to see all available options.</p>',
    variables: [
      'first_name',
      'last_name',
      'email',
