...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Form component for creating email campaigns with trigger configuration. Supports various trigger types including manual, signup, verified, milestone, scheduled, and inactive.",
			},
		},
	},
	argTypes: {
