...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Displays a list of email templates with actions like preview, edit, duplicate, and delete. Shows template details including name, type, subject, preheader, and status. Note: This component currently shows an empty state in Storybook. In production, it fetches templates from the API.",
			},
		},
	},
	argTypes: {
