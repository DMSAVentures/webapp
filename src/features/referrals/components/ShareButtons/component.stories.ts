...
export const CustomMessage: Story = {
	args: {
		referralUrl: "https://example.com?ref=USER123ABC",
		message:
			"🚀 I just joined this awesome waitlist! Join me and move up the list together!",
	},
};
...
export const LongUrl: Story = {
	args: {
		referralUrl:
			"https://my-very-long-subdomain.example-waitlist-platform.com/campaign/summer-2024?ref=VERYLONGREFERRALCODE123456789",
		message:
			"Join me on this incredible journey! This platform is amazing and I think you will love it too.",
	},
};
