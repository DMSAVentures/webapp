import { memo, useCallback, HTMLAttributes, useState } from 'react';
...
const platformConfigs: Record<Exclude<SharePlatform, 'copy'>, PlatformConfig> = {
    twitter: {
        label: 'Twitter',
...
export const ShareButtons = memo(function ShareButtons({
    ...
    const handleShare = useCallback((platform: Exclude<SharePlatform, 'copy'>) => {
    ...
    return (
        <div className={classNames} {...props}>
            <div className={styles.container}>
                ...
                {(Object.keys(platformConfigs) as Array<keyof typeof platformConfigs>).map((platform) => {
                    const config = platformConfigs[platform];
                    return (
                        <Button
                            key={platform}
