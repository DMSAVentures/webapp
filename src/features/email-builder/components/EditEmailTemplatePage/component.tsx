/**
 * EditEmailTemplatePage Component
 * Page for editing an existing email template
 */
...
/**
 * EditEmailTemplatePage allows editing an existing email template
 */
export const EditEmailTemplatePage = memo(function EditEmailTemplatePage({
	templateId,
...
EditEmailTemplatePage.displayName = "EditEmailTemplatePage";
