 ...
 */
export const NewCampaignEmailTemplatePage = memo(
	function NewCampaignEmailTemplatePage() {
		...
		// API hooks
		const { createTemplate, loading: saving } =
						...
						<aside className={styles.rightPanel}>
							<div className={styles.panelModeToggle}>
								<ButtonGroup isAttached isFullWidth>
									<Button
										variant={
											rightPanelMode === "block" ? "primary" : "secondary"
										}
										size="sm"
