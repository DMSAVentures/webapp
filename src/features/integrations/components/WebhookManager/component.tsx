 ...
 */
const getWebhookHealth = (webhook: Webhook): "healthy" | "warning" | "error" => {
 ...
 */
export const WebhookManager = memo<WebhookManagerProps>(function WebhookManager({
	campaignId,
	webhooks,
	onCreate,
	onEdit,
								...
								{isExpanded && (
									<>
										...
										<div className={styles.webhookDetails}>
											...
											{/* Retry config */}
											<div className={styles.detailSection}>
												<h4 className={styles.detailTitle}>Retry Configuration</h4>
