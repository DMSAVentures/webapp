...
export const FullyConfigured: Story = {
  args: {
    initialData: {
      ...
      description: 'Building anticipation for our revolutionary AI-powered product. Join our exclusive waitlist to be among the first to experience the future of automation.',
      settings: {
