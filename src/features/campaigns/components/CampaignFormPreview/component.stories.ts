	...
	args: {
		campaign: {
			...
			form_config: {
				...
				custom_css:
					'__DESIGN__:{"layout":"two-column","colors":{"primary":"#8b5cf6","background":"#ffffff","text":"#1f2937","border":"#e5e7eb","error":"#ef4444","success":"#10b981"},"typography":{"fontFamily":"Inter, system-ui, sans-serif","fontSize":16,"fontWeight":400},"spacing":{"padding":16,"gap":16},"borderRadius":8,"customCss":""}',
			},
		},
	},
};
	...
	args: {
		campaign: {
			...
			form_config: {
				...mockCampaign.form_config!,
				custom_css:
					'__DESIGN__:{"layout":"single-column","colors":{"primary":"#ec4899","background":"#fdf2f8","text":"#831843","border":"#fbcfe8","error":"#be123c","success":"#15803d"},"typography":{"fontFamily":"Inter, system-ui, sans-serif","fontSize":16,"fontWeight":400},"spacing":{"padding":20,"gap":20},"borderRadius":12,"customCss":""}',
			},
		},
	},
};
