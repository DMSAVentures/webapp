...
export const Interactive: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					'This component displays team members with full management capabilities. Click "Invite Member" to add new members, use the role dropdown to change permissions, and click the delete icon to remove members.',
			},
		},
	},
};
