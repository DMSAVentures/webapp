...
import { mockRewards, getMockRewardsByCampaign, mockRewardsSortedByTier } from '@/mocks/rewards.mock';
    ...
    rewards: [
      {
        ...
        description: 'This is an incredibly detailed description that explains every single aspect of this reward in great detail, including all the benefits, terms, conditions, and special features that come with it. It might be quite long and should wrap properly.',
      },
      mockRewards[1],
      {
        ...mockRewards[2],
        value: 'Really Long Value Description: 3 months of premium access plus bonus features and additional perks',
      },
    ].sort((a, b) => a.tier - b.tier),
    currentUserProgress: {
      referralCount: 3,
