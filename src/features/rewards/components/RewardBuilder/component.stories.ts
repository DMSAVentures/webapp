...
export const FullyConfigured: Story = {
  args: {
    ...
    initialData: {
      ...
      description: 'The ultimate reward package with lifetime access, exclusive events, and premium swag. Limited to only 10 lucky winners who refer 50 or more people.',
      type: 'premium_feature',
