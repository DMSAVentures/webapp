...
import { ToggleWithLabel } from "@/proto-design-system/Toggle/ToggleWithLabel/toggleWithLabel";
...
const Template = (
	args: React.ComponentProps<typeof ToggleWithLabel> & { checked: boolean },
) => {
	...
	return (
		<ToggleWithLabel {...args} checked={checked} onChange={handleChange} />
	);
};
