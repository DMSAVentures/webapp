...
import Modal, { ModalProps } from "@/proto-design-system/modal/modal";
...
export const SuccessWithDescriptionModal: Story = {
	...
	args: {
		...
		icon: "success",
		description:
			"This is a long description for the modal box where all tha content is going to fit and this should not expand.",
		onCancel: fn(),
		onProceed: fn(),
		cancelText: "Cancel",
		proceedText: "Proceed",
...
export const ModalWithFooter: Story = {
	args: {
		...
		description: "Description",
		footerLeftChildren: (
			<HintText hintText={"Terms and conditions apply"} state={"default"} />
		),
