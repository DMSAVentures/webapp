...
export const Vertical: Story = {
  args: {
    steps: [
      ...
      { id: "2", label: "Processing", description: "We are preparing your order" },
      { id: "3", label: "Shipped", description: "Your order is on its way" },
      { id: "4", label: "Delivered", description: "Package delivered to your address" },
    ],
    currentStep: 2,
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          ...
          <button
            type="button"
            onClick={() => setCurrentStep((prev) => Math.min(basicSteps.length - 1, prev + 1))}
