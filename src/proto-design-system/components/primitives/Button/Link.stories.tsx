...
export const InlineText: Story = {
  render: () => (
    <p style={{ maxWidth: "400px", lineHeight: 1.6 }}>
      This is a paragraph with an <Link href="#">inline link</Link> that flows naturally within the
      text. You can also have <Link href="#">multiple links</Link> in the same paragraph.
    </p>
  ),
};
...
export const InlineMuted: Story = {
  render: () => (
    <p style={{ maxWidth: "400px", lineHeight: 1.6, color: "var(--color-muted)" }}>
...
export const Showcase: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      <div>
        <p style={{ marginBottom: "0.5rem", fontSize: "0.875rem", color: "var(--color-muted)" }}>
          Standard links
        </p>
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          ...
          <Link href="#" target="_blank" rightIcon={<ExternalLink size="1em" />}>
            External
          </Link>
        </div>
      </div>
