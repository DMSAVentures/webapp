import { AlertCircle, File, FileArchive, FileText, Image, Upload, X } from "lucide-react";
...
export function FileUpload({
  ...
  const handleFiles = useCallback(
    (fileList: FileList | null) => {
      ...
      const maxAllowed = maxFiles ? maxFiles - existingCount : Number.POSITIVE_INFINITY;
    ...
    <div className={cn(styles.fileUpload, className)}>
      {variant === "dropzone" ? (
        ...
        >
          ...
          {accept && <span className={styles.acceptedTypes}>Accepted: {accept}</span>}
        </button>
      ) : (
        <button
          type="button"
            ...
            return (
              <li key={uploadedFile.id} className={styles.fileItem}>
                ...
                <div className={styles.fileInfo}>
                  ...
                  {uploadedFile.progress !== undefined && !uploadedFile.error && (
