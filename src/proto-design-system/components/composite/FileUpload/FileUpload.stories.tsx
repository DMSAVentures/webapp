...
export const ButtonVariant: Story = {
  render: () => {
    const [files, setFiles] = useState<UploadedFile[]>([]);
    return <FileUpload variant="button" files={files} onFilesChange={setFiles} multiple />;
  },
};
...
export const Disabled: Story = {
  render: () => {
    return <FileUpload disabled label="Upload disabled" description="Cannot upload files" />;
  },
};
