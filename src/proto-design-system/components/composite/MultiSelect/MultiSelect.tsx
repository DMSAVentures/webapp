    ...
    >
      ...
      >
        <span className={styles.triggerContent}>
          ...
          <span className={styles.visibleContent}>
            {selectedItems.length === 0 ? (
              ...
              <span className={styles.label}>{selectedItems.length} selected</span>
            )}
          </span>
        </span>
        <span className={styles.actions}>
          <button
            type="button"
            className={cn(styles.clearButton, selectedItems.length === 0 && styles.clearButtonHidden)}
        ...
        {isOpen && (
          <motion.ul
            ...
            aria-activedescendant={
              focusedIndex >= 0 ? `multiselect-item-${enabledItems[focusedIndex]?.id}` : undefined
            }
            ...
            {items.map((item) => {
              ...
              return (
                <li key={item.id}>
                  ...
                  >
                    <span className={cn(styles.checkbox, isSelected && styles.checked)}>
                      {isSelected && <Check />}
                    </span>
