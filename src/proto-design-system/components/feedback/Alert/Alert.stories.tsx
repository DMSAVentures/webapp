  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      <Alert variant="success" title="Payment successful" dismissible>
        Your payment of $99.00 has been processed. A confirmation email has been sent to your
        address.
      </Alert>
      ...
      <Alert variant="info">New features are available! Check out our latest update notes.</Alert>
    </div>
  ),
};
