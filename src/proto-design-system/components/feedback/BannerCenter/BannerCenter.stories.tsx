...
function BannerControls() {
  ...
  const addInfoBanner = () => {
    addBanner({
      ...
      action: <Button size="sm" variant="ghost">Update Now</Button>,
    });
  };
  ...
  const addWarningBanner = () => {
    addBanner({
      ...
      action: <Button size="sm" variant="ghost">Upgrade</Button>,
    });
  };
  ...
  return (
    <div style={{ padding: "var(--space-6)", display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
      ...
      <h3 style={{ margin: 0, marginTop: "var(--space-4)" }}>Add Non-Dismissible Banner</h3>
      <div style={{ display: "flex", gap: "var(--space-2)" }}>
        <Button onClick={addNonDismissible} variant="outline">Add Maintenance Notice</Button>
      </div>

      <h3 style={{ margin: 0, marginTop: "var(--space-4)" }}>Clear Banners</h3>
      <div style={{ display: "flex", gap: "var(--space-2)" }}>
        <Button onClick={clearDismissible} variant="outline">Clear Dismissible</Button>
...
function NonDismissibleDemo() {
  ...
  return (
    <div style={{ padding: "var(--space-6)" }}>
      <p>Notice how the non-dismissible warning banner stays at the bottom while dismissible banners stack on top.</p>
    </div>
  );
}
...
function MultipleNonDismissibleDemo() {
  ...
  return (
    <div style={{ padding: "var(--space-6)" }}>
      <p>Multiple non-dismissible banners stack in the bottom row, dismissible ones on top.</p>
    </div>
  );
}
