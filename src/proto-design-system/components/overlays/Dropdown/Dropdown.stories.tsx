...
import { Copy, Download, Edit, LogOut, Settings, Share, Trash2, User } from "lucide-react";
...
export const Sizes: Story = {
  render: () => {
    ...
    return (
      ...
      >
        <Dropdown items={items} value={sm} onChange={setSm} size="sm" placeholder="Small" />
        <Dropdown items={items} value={md} onChange={setMd} size="md" placeholder="Medium" />
        <Dropdown items={items} value={lg} onChange={setLg} size="lg" placeholder="Large" />
      </div>
    );
  },
};
...
export const WithDisabledItems: Story = {
  render: () => {
    ...
    return (
      <Dropdown items={items} value={value} onChange={setValue} placeholder="Select action..." />
    );
  },
};
...
export const WithDividers: Story = {
  render: () => {
    ...
    return <Dropdown items={items} value={value} onChange={setValue} placeholder="Account" />;
  },
};
