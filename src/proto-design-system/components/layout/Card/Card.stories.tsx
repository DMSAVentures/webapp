  ...
  args: {
    ...
    children: (
      <>
        ...
        <p style={{ margin: 0, color: "var(--color-muted)" }}>This card has a shadow effect.</p>
      </>
    ),
  },
};
  ...
  args: {
    ...
    children: (
      <>
        ...
        <p style={{ margin: 0, color: "var(--color-muted)" }}>This card has a border.</p>
      </>
    ),
  },
};
  ...
  args: {
    ...
    children: (
      <>
        ...
        <p style={{ margin: 0, color: "var(--color-muted)" }}>This card has a filled background.</p>
      </>
    ),
  },
};
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <Card variant="filled">
        ...
        <p style={{ margin: 0, color: "var(--color-muted)" }}>With background</p>
      </Card>
    </div>
  ),
};
  ...
  args: {
    ...
    children: (
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ margin: "0 0 1rem", color: "var(--color-muted)" }}>Software Engineer</p>
        <button
          type="button"
          style={{
            background: "var(--color-primary)",
