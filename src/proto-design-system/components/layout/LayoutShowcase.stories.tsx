...
import { BannerCenterProvider, useBannerCenter } from "../feedback/BannerCenter";
        ...
        <Grid columns="3" gap="lg">
          <Card variant="elevated" padding="lg">
            <Stack gap="sm">
              ...
              <p style={{ color: "var(--color-muted)", margin: 0 }}>
                Shadow-based depth. Best for primary content that needs emphasis.
              </p>
            </Stack>
          </Card>
...
const StatCard = ({
  ...
  <Card variant={variant} padding="lg">
    <Stack gap="md">
      ...
      <div>
        <div style={{ fontSize: "var(--font-size-2xl)", fontWeight: 600 }}>{value}</div>
        <div
          style={{
...
export const DashboardWithOutlinedCards: Story = {
  render: () => (
    <div style={{ backgroundColor: "var(--color-base-50)", minHeight: "100vh" }}>
      <Container size="xl" style={{ padding: "var(--space-8)" }}>
        <Stack gap="xl">
          <div>
              ...
              <CardBody>
                <Stack gap="md">
                  {[
                    ...
                    <Stack key={sale.email} direction="row" justify="between" align="center">
                      <Stack gap="xs">
    ...
    <Container size="xl" style={{ padding: "var(--space-8)" }}>
      <Stack gap="xl">
        ...
        <Grid columns="3" gap="lg">
          ...
          <Card variant="elevated" padding="lg" style={{ gridColumn: "span 2" }}>
            <Stack gap="md">
              ...
              <p style={{ color: "var(--color-muted)", margin: 0 }}>
                Use elevated cards for your most important content. The shadow provides
                visual prominence and draws the user's attention first.
              </p>
          ...
          <Stack gap="lg">
            ...
            <Card variant="outlined" padding="md">
              <Stack gap="sm">
                ...
                <div style={{ fontSize: "var(--font-size-2xl)", fontWeight: 600 }}>12.5%</div>
                <span style={{ color: "var(--color-muted)", fontSize: "var(--font-size-sm)" }}>
                  +2.3% from last week
                </span>
              </Stack>
        ...
        <Stack gap="lg">
          ...
          <Card variant="outlined" padding="none">
            ...
            <CardBody>
              <Stack gap="md">
                {[
                  { label: "Email notifications", description: "Receive emails about your account activity" },
                  ...
                  <Stack key={item.label} direction="row" justify="between" align="center">
                    <Stack gap="0">
          ...
          <Card variant="filled" padding="lg">
            <Stack direction="row" justify="between" align="center" wrap gap="md">
              ...
              <Button variant="destructive" style={{ flexShrink: 0 }}>Delete Account</Button>
            </Stack>
          </Card>
        </Stack>
      </Stack>
      ...
      <Stack gap="xl">
        ...
        <Grid columns="3" gap="lg">
          {[
            ...
            >
              <Stack gap="sm">
                <span style={{ fontSize: "var(--font-size-2xl)" }}>{item.icon}</span>
      ...
      <Stack gap="md">
        ...
        <Stack direction="row" justify="between" align="start">
          ...
          <Stack direction="row" gap="sm" align="center">
            ...
            <Button variant="ghost" size="sm" style={{ padding: "var(--space-1)" }}>
        ...
        {/* Footer */}
        <Stack direction="row" gap="sm" align="center" style={{ color: "var(--color-muted)" }}>
          <Calendar size={12} />
          <span style={{ fontSize: "var(--font-size-xs)" }}>Created {campaign.createdAt}</span>
        </Stack>
      </Stack>
    </CardBody>
  </Card>
    ...
    <div style={{ backgroundColor: "var(--color-surface)", minHeight: "100vh" }}>
      <Container size="xl" style={{ padding: "var(--space-8)" }}>
        <Stack gap="lg">
          ...
          <Grid columns="3" gap="md">
            {campaigns.map((campaign) => (
              <CampaignCard key={campaign.id} campaign={campaign} variant="filled" />
            ))}
          </Grid>
        </Stack>
      </Container>
    ...
    <div style={{ backgroundColor: "var(--color-base-100)", minHeight: "100vh" }}>
      <Container size="xl" style={{ padding: "var(--space-8)" }}>
        <Stack gap="lg">
          ...
          <Grid columns="3" gap="md">
            {campaigns.map((campaign) => (
              <CampaignCard key={campaign.id} campaign={campaign} variant="elevated" />
            ))}
          </Grid>
        </Stack>
      </Container>
      ...
      <Stack direction="row" gap="sm" align="center">
        <div
          style={{
            ...
            height: "24px",
            borderRadius: "50%",
            backgroundColor: completed ? "var(--color-success)" : "var(--color-base-200)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
        >
          {completed && <Check size={14} style={{ color: "var(--color-success-content)" }} />}
        </div>
        <Stack gap="0">
          ...
          <Container size="xl" style={{ padding: "var(--space-8)" }}>
            <Stack gap="lg">
              ...
              <Stack direction="row" gap="sm" align="center" style={{ color: "var(--color-muted)" }}>
                ...
                <span style={{ fontSize: "var(--font-size-sm)", color: "var(--color-base-content)" }}>
                  Product Launch 2026
                </span>
              </Stack>
              ...
              {/* Tabs */}
              <Tabs activeTab={activeTab} onTabChange={setActiveTab} variant="line">
                <TabList>
              ...
              <Stack gap="xl">
                {/* Launch Checklist */}
                <Stack gap="md">
                  <h2 style={{ margin: 0, fontSize: "var(--font-size-lg)" }}>Launch Checklist</h2>
                  <Stack gap="sm">
                    <ChecklistItem
                ...
                <Grid columns="2" gap="md">
                  <Card variant="outlined" padding="lg">
                    <Stack direction="row" gap="md" align="center">
                      ...
                      >
                        <Users size={24} style={{ color: "var(--color-primary-content)" }} />
                      </div>
                      <Stack gap="0">
                        <span
                          style={{
                        ...
                        <span style={{ fontSize: "var(--font-size-3xl)", fontWeight: 700 }}>181</span>
                        <span style={{ color: "var(--color-muted)", fontSize: "var(--font-size-sm)" }}>
                  ...
                  <Card variant="outlined" padding="lg">
                    <Stack direction="row" gap="md" align="center">
                      ...
                      >
                        <ShieldCheck size={24} style={{ color: "var(--color-success-content)" }} />
                      </div>
                      <Stack gap="0">
                        <span
                          style={{
                        ...
                        <Stack direction="row" gap="sm" align="baseline">
                          <span style={{ fontSize: "var(--font-size-3xl)", fontWeight: 700 }}>0</span>
                          <span style={{ color: "var(--color-muted)", fontSize: "var(--font-size-sm)" }}>
                            (0.0%)
                          </span>
                        </Stack>
                ...
                {/* Configuration */}
                <Stack gap="md">
                  <h2 style={{ margin: 0, fontSize: "var(--font-size-lg)" }}>Configuration</h2>
                  <Grid columns="3" gap="md">
                ...
                <Stack gap="md">
                  <Stack gap="xs">
                    <h2 style={{ margin: 0, fontSize: "var(--font-size-lg)" }}>Form Preview</h2>
                    <p style={{ color: "var(--color-muted)", margin: 0 }}>
        ...
        <Stack gap="lg">
          ...
          <Card variant="elevated" padding="lg">
            <Stack direction="row" justify="between" align="center">
              <Stack gap="sm">
                <Stack direction="row" gap="sm" align="center">
                  <h1 style={{ margin: 0, fontSize: "var(--font-size-xl)" }}>Product Launch 2026</h1>
                  <Badge variant="warning">Draft</Badge>
                </Stack>
                <p style={{ color: "var(--color-muted)", margin: 0 }}>
          ...
          <Grid columns="4" gap="md">
            <Card variant="elevated" padding="md">
              <Stack gap="xs">
                <span style={{ color: "var(--color-muted)", fontSize: "var(--font-size-xs)", textTransform: "uppercase" }}>
                  Total Signups
                </span>
                <span style={{ fontSize: "var(--font-size-2xl)", fontWeight: 700 }}>181</span>
              </Stack>
            </Card>
            <Card variant="elevated" padding="md">
              <Stack gap="xs">
                ...
                <span style={{ fontSize: "var(--font-size-2xl)", fontWeight: 700 }}>0</span>
              </Stack>
            </Card>
            <Card variant="elevated" padding="md">
              <Stack gap="xs">
                ...
                <span style={{ fontSize: "var(--font-size-2xl)", fontWeight: 700 }}>29</span>
              </Stack>
            </Card>
            <Card variant="elevated" padding="md">
              <Stack gap="xs">
                ...
                <span style={{ fontSize: "var(--font-size-2xl)", fontWeight: 700 }}>0.2</span>
              </Stack>
            </Card>
          </Grid>
            ...
            <Card variant="elevated" padding="none">
              <CardHeader>
                <Stack direction="row" justify="between" align="center">
                  ...
                  <Badge variant="success" size="sm">2/3 Complete</Badge>
                </Stack>
              </CardHeader>
              <CardBody>
                <Stack gap="sm">
                  {[
                    ...
                    <Stack key={item.title} direction="row" gap="sm" align="center">
                      <CheckCircle2
                        size={20}
                        style={{
                          color: item.done ? "var(--color-success)" : "var(--color-base-300)",
                        }}
                      />
                      <span
                        style={{
            ...
            <Card variant="elevated" padding="none">
              ...
              <CardBody>
                <Stack gap="md">
                  ...
                  <Stack direction="row" justify="between" align="center">
                    <Stack direction="row" gap="sm" align="center">
                      <Share2 size={18} style={{ color: "var(--color-muted)" }} />
                      <span>Referrals</span>
                    </Stack>
        ...
        <div style={{ display: "flex", minHeight: "100vh" }}>
          ...
          >
            ...
            <Stack gap="sm">
              ...
              <Stack gap="xs">
                <h2 style={{ margin: 0, fontSize: "var(--font-size-base)" }}>Product Launch 2026</h2>
            ...
            <Container size="lg" style={{ padding: "var(--space-8)" }}>
              <Stack gap="xl">
                ...
                <Stack gap="md">
                  ...
                  <Grid columns="3" gap="md">
                    <ConfigCard icon={Mail} title="Email">
                      <Badge variant="success" size="sm">Verification On</Badge>
                    </ConfigCard>
                    <ConfigCard icon={Share2} title="Referrals">
                      <Badge variant="default" size="sm">Disabled</Badge>
                    </ConfigCard>
    ...
    const DropdownNavDemo = () => {
      ...
      return (
        <div style={{ backgroundColor: "var(--color-base-50)", minHeight: "100vh" }}>
          ...
          >
            <Container size="xl" style={{ padding: "var(--space-4) var(--space-6)" }}>
              <Stack direction="row" justify="between" align="center">
                {/* Left: Back + Title */}
                <Stack direction="row" gap="md" align="center">
                  <button
                  ...
                  <Stack gap="0">
                    <Stack direction="row" gap="sm" align="center">
                      <h1 style={{ margin: 0, fontSize: "var(--font-size-lg)" }}>Product Launch 2026</h1>
                      <Badge variant="warning" size="sm">Draft</Badge>
                    </Stack>
                  </Stack>
                </Stack>
          ...
          <div style={{ backgroundColor: "var(--color-surface)", borderBottom: "1px solid var(--color-border)" }}>
            <Container size="xl" style={{ padding: "var(--space-3) var(--space-6)" }}>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            color: isActive ? "var(--color-base-content)" : "var(--color-muted)",
                            cursor: "pointer",
                            width: "100%",
                            textAlign: "left",
                            fontSize: "var(--font-size-sm)",
                        ...
                        >
                          ...
                          {item.label}
                          {isActive && (
                            <Check size={16} style={{ marginLeft: "auto", color: "var(--color-primary)" }} />
                          )}
                        </button>
                      );
                    })}
          ...
          {/* Content */}
          <Container size="xl" style={{ padding: "var(--space-8) var(--space-6)" }}>
            <Stack gap="xl">
              {/* Stats */}
              <Grid columns="2" gap="md">
                <Card variant="outlined" padding="lg">
                ...
                <Stack gap="md">
                  <Stack direction="row" justify="between" align="start">
                    <Stack gap="xs">
                      ...
                      <p style={{ color: "var(--color-muted)", margin: 0 }}>Launching camp.xyz</p>
                    </Stack>
                    <Stack direction="row" gap="sm">
                      <Button variant="outline">Preview</Button>
                      <Button>Go Live</Button>
                      ...
                      <Stack gap="sm">
                        {[
                          ...
                          <Stack key={item.title} direction="row" gap="sm" align="center">
                            <CheckCircle2
                              size={20}
                              style={{ color: item.done ? "var(--color-success)" : "var(--color-base-300)" }}
                            />
                            <span style={{ color: item.done ? "var(--color-muted)" : "inherit" }}>
                              {item.title}
                            </span>
                          </Stack>
                        ))}
    ...
    const FullAppContent = () => {
      ...
      const handleGoLive = () => {
        addBanner({
          ...
          description: "Product Launch 2026 has been published and is now accepting signups.",
          dismissible: true,
        });
      };
            ...
            {collapsed ? (
              ...
              <Stack direction="row" gap="sm" align="center" style={{ width: "100%" }}>
                ...
                <Stack gap="0" style={{ flex: 1, minWidth: 0 }}>
                  <span style={{ fontSize: "var(--font-size-sm)", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    Jane Doe
                  </span>
                  <span style={{ fontSize: "var(--font-size-xs)", color: "var(--color-muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    jane@acme.com
                  </span>
                </Stack>
                <Button
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
              ...
              >
                <Stack direction="row" justify="between" align="center" wrap gap="sm">
                  <Stack direction="row" gap="sm" align="center" wrap style={{ minWidth: 0 }}>
                    {/* Mobile menu button */}
                    <SidebarMobileTrigger />
                    {/* Breadcrumb */}
                    <Stack direction="row" gap="sm" align="center" style={{ color: "var(--color-muted)" }}>
                      <span style={{ fontSize: "var(--font-size-sm)" }}>Campaigns</span>
                      <ChevronRight size={14} />
                      <span style={{ fontSize: "var(--font-size-sm)", color: "var(--color-base-content)", fontWeight: 500 }}>
                        Product Launch 2026
                      </span>
                    </Stack>
                    <Badge variant="warning" size="sm">Draft</Badge>
                  ...
                  <Stack direction="row" gap="sm" style={{ flexShrink: 0 }}>
                    ...
                    <Button size="sm" onClick={handleGoLive}>Go Live</Button>
                  </Stack>
                </Stack>
              </header>
              ...
              <div className={showcaseStyles.contentPadding}>
                <Stack gap="lg" animate key={activeSection}>
                  ...
                  <Card variant="outlined" padding="none" style={{ overflow: "hidden" }}>
                    ...
                    >
                      <Card variant="elevated" padding="lg" style={{ width: "100%", maxWidth: "380px" }}>
                        <Stack gap="md">
                          <Stack gap="sm">
                            <label style={{ fontWeight: 500, fontSize: "var(--font-size-sm)" }}>
                              Email <span style={{ color: "var(--color-error)" }}>*</span>
                            </label>
                            <input
                              type="email"
                          ...
                          <Button style={{ width: "100%" }}>Join Waitlist</Button>
                          <p style={{ margin: 0, textAlign: "center", color: "var(--color-muted)", fontSize: "var(--font-size-xs)" }}>
      ...
      return (
        ...
        <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
            ...
            >
              <Stack direction="row" justify="between" align="center" wrap gap="sm">
                <Stack direction="row" gap="sm" align="center" style={{ minWidth: 0 }}>
                  ...
                  <SidebarMobileTrigger />
                  <Stack gap="0">
                    <h1 style={{ margin: 0, fontSize: "var(--font-size-lg)" }}>Campaigns</h1>
                    <p style={{ color: "var(--color-muted)", margin: 0, fontSize: "var(--font-size-sm)" }}>
            ...
            >
              <Stack direction="row" justify="between" align="center" gap="sm" style={{ minWidth: "max-content" }}>
                <Stack direction="row" gap="sm" align="center">
                  {/* Search */}
                    ...
                    {["All", "Active", "Draft", "Paused"].map((filter, i) => (
                      <button
                        ...
                        style={{
                          ...
                          border: "1px solid var(--color-border)",
                          borderRadius: "var(--radius-full)",
                          background: i === 0 ? "var(--color-base-content)" : "transparent",
                          color: i === 0 ? "var(--color-base-100)" : "var(--color-muted)",
                          cursor: "pointer",
                          fontSize: "var(--font-size-sm)",
                          whiteSpace: "nowrap",
                        }}
