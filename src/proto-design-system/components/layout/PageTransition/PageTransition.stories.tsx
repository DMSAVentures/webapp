...
const pages = [
  { id: "home", title: "Home", content: "Welcome to the home page. This is where you start your journey." },
  { id: "about", title: "About", content: "Learn more about us and what we do. We build great things." },
  { id: "contact", title: "Contact", content: "Get in touch with our team. We'd love to hear from you." },
];
  ...
  render: (args) => {
    ...
    return (
      <Stack gap="lg">
        ...
        <PageTransition pageKey={activeTab} type={args.type} duration={args.duration}>
