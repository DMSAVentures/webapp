...
export const NavbarExample: Story = {
  render: () => (
    <Stack direction="row" justify="between" align="center" style={{ padding: "1rem" }}>
      <Box>Logo</Box>
...
export const Animated: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Stack children animate in with a stagger effect. Refresh to see animation.",
      },
    },
  },
};
...
export const AnimatedDashboard: Story = {
      ...
      >
        {["Revenue", "Users", "Orders", "Growth"].map((label) => (
          ...
          >
            ...
            <p style={{ margin: "0.25rem 0 0", fontSize: "var(--font-size-xl)", fontWeight: 700 }}>
              $12,345
            </p>
          </div>
        ))}
  ...
  parameters: {
    docs: {
      description: {
        story: "Dashboard layout with staggered sections. Each major section animates in sequence.",
      },
    },
  },
};
